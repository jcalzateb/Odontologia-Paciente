...
class PacienteServiceTest {
    ...
    static void setUp(){
        ...
        paciente = new Paciente(1L, "Carlos", "Portes", 12345, LocalDate.of(2024, 7, 23),
                new Domicilio(1L, "Avenida ", 54321, "sur", "valle"));

        pacienteEntradaDto = new PacienteEntradaDto("Carlos", "Portes", 12345, LocalDate.of(2024, 7, 23), new DomicilioEntradaDto("Avenida ", 54321, "sur", "valle"));
    }
